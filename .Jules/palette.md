...
## 2026-05-28 - [Interactive Navigation Logo]
**Learning:** Enhancing the brand/home logo with subtle interactive states (like letter-spacing and brightness transitions) provides immediate visual feedback and a sense of polish. Coupling this with an explicit ARIA label ensures the brand acronym is meaningful to screen readers.
**Action:** Always provide interactive hover/focus states for navigation logos and use aria-label to clarify the destination for non-textual or abbreviated brand marks.
